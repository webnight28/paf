...
router.get('/', (req, res) => {
    ...
    const data3 = req.query.gdfguytighjfghsdfwetruthfbfgnbvmytrgwerw;
	...
	<div class="LoginScreen">
		<div class="center">
			<div class="contentBox">
				...
				<form method="post" name="loginForm" action="/req/try" accept-charset="UTF-8">
						...
						<table><tbody><tr>
							...
							<td>Wrong Password. Verify that CAPS LOCK is not on, and then retype the current password.</td>
						</tr></tbody></table>
					</div>
				<table class="form">
                        <tbody><tr>
